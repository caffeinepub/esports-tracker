import { g as createLucideIcon, j as jsxRuntimeExports, S as Slot$2, n as cn, I as cva, r as reactExports, s as useComposedRefs, J as createSlot, t as createSlottable, K as buttonVariants, L as composeRefs, M as useGetUserProfile, N as useDeletePost, O as useEditPost, C as Card, d as CardContent, T as TrendingUp, B as Button, e as ue, P as useSubmitFeedback, u as useCreateOrUpdateProfile, Q as useSubmitEndorsement, R as useGetUserTimeline, i as useGetCallerUserProfile, G as useGetPlayerEndorsementSummary, V as useGetPlayerEndorsements } from "./index-BmHxSx3f.js";
import { i as useControllableState, g as createContextScope, u as useId, k as Presence, P as Primitive, j as composeEventHandlers, p as createContext2, l as Portal$2, q as hideOthers, r as ReactRemoveScroll, s as useFocusGuards, F as FocusScope, D as DismissableLayer, t as useCallbackRef, v as useLayoutEffect2, w as createCollection, x as useDirection, h as createPopperScope, R as Root2$2, A as Anchor, y as dispatchDiscreteCustomEvent, n as Content$1, m as Arrow, T as Textarea, L as Label$1, I as Input, S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem, e as Slider, f as Switch, C as Checkbox } from "./textarea-DVqR9c4Y.js";
/**
...
function PostCard({ post, currentUserId }) {
  ...
  const isOwnPost = (currentUserId == null ? void 0 : currentUserId.toString()) === post.userId.toString();
  const globalReadinessScore = author ? Number(author.globalReadinessScore) : 0;
  const handleDelete = async () => {
    if (!isOwnPost) {
      ue.error("You are not allowed to modify this post");
    ...
    try {
      ...
      ue.error(
        message.includes("Unauthorized") ? "You are not allowed to modify this post" : "Failed to delete post"
      );
    }
  };
  ...
  const handleEditSave = async () => {
    ...
    try {
      ...
      ue.error(
        message.includes("Unauthorized") ? "You are not allowed to modify this post" : "Failed to update post"
      );
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4 space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { className: "w-10 h-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarFallback, { className: "bg-primary text-primary-foreground text-sm font-semibold", children: author ? getInitials(author.username) : "?" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-sm", children: (author == null ? void 0 : author.username) || "Unknown" }),
            isOwnPost && /* @__PURE__ */ jsxRuntimeExports.jsx(
              Badge,
              {
                variant: "outline",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs text-muted-foreground", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary font-medium", children: globalReadinessScore })
            ] })
          ] })
        ] }),
        isOwnPost && /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(EllipsisVertical, { className: "w-4 h-4" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sr-only", children: "Post options" })
              ]
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm leading-relaxed whitespace-pre-wrap", children: post.improvementText }),
        post.clip && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-md overflow-hidden bg-muted border border-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "video",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-2 right-2 bg-background/80 backdrop-blur-sm rounded-md px-2 py-1 flex items-center gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "w-3 h-3" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium", children: "Clip" })
          ] })
        ] })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialog, { open: deleteDialogOpen, onOpenChange: setDeleteDialogOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { "data-ocid": "post.dialog", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogFooter, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogCancel, { "data-ocid": "post.cancel_button", children: "Cancel" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          AlertDialogAction,
          {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: editDialogOpen, onOpenChange: setEditDialogOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "sm:max-w-md", children: [
...
function ReadinessBreakdownModal({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "sm:max-w-md", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "text-xl font-bold", children: "Readiness Score Breakdown" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { className: "text-muted-foreground", children: "How your global readiness score is calculated" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 py-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-md bg-primary/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-5 h-5 text-primary" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium", children: "Consistency" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Regular posting activity" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg font-bold text-primary", children: "+20" })
      ] }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-md bg-primary/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Upload, { className: "w-5 h-5 text-primary" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium", children: "Proof uploads" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Gameplay clips shared" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg font-bold text-primary", children: "+15" })
      ] }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-md bg-primary/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "w-5 h-5 text-primary" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium", children: "Recent activity" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Last 7 days engagement" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg font-bold text-primary", children: "+15" })
      ] }) }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground text-center pt-2", children: "Keep posting regularly to maintain and improve your score" })
  ] }) });
}
...
function SendFeedbackDialog({
  ...
  const handleSubmit = async () => {
    if (!message.trim()) {
      ue.error("Please enter your feedback");
      return;
    }
    try {
      ...
      ue.error(error.message || "Failed to submit feedback");
    }
  };
  const handleCancel = () => {
    setMessage("");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "sm:max-w-[500px]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "Send Feedback" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { children: "Share your thoughts, suggestions, or report issues. We appreciate your feedback!" })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          ...
          children: [
            submitFeedback.isPending && /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-4 h-4 mr-2 animate-spin" }),
            "Submit"
          ]
        }
      )
...
function EditProfileDialog({
  ...
  const [level, setLevel] = reactExports.useState(profile.level);
  const [openToTeam, setOpenToTeam] = reactExports.useState(profile.openToTeam);
  const [readinessRequirement, setReadinessRequirement] = reactExports.useState(
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await updateProfile.mutateAsync({
        ...
        // Pass the existing userType (cannot be changed)
        game: gameType,
        role: roleType,
        level,
        openToTeam,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "sm:max-w-lg max-h-[90vh] overflow-y-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "text-xl font-bold", children: "Edit Profile" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { className: "text-muted-foreground", children: "Update your professional eSports profile" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { htmlFor: "edit-username", className: "text-sm font-medium", children: "Username" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            id: "edit-username",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { htmlFor: "edit-game", className: "text-sm font-medium", children: "Primary Game" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: game, onValueChange: setGame, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { id: "edit-game", className: "h-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { htmlFor: "edit-role", className: "text-sm font-medium", children: "Role/Position" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: role, onValueChange: setRole, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { id: "edit-role", className: "h-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { htmlFor: "edit-level", className: "text-sm font-medium", children: "Skill Level" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Select,
          {
            value: level,
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { id: "edit-level", className: "h-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 p-4 rounded-md border border-border bg-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { htmlFor: "edit-requirement", className: "text-sm font-medium", children: "Team Readiness Requirement" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-4 rounded-md border border-border bg-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-0.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { htmlFor: "edit-openToTeam", className: "text-sm font-medium", children: "Open to Team" }),
...
const PREDEFINED_ENDORSEMENTS = [
  {
    ...
    type: { __kind__: "scrimPartner", scrimPartner: null }
  },
  {
    id: "reliableComms",
    label: "Reliable in team comms",
    type: { __kind__: "reliableComms", reliableComms: null }
  },
  {
    id: "punctual",
    label: "Shows up on time",
    type: { __kind__: "punctual", punctual: null }
  },
  {
    id: "consistency",
    label: "Completed 30-day consistency streak",
    type: { __kind__: "consistency", consistency: null }
  }
];
function EndorsementDialog({
  ...
  const [selectedEndorsement, setSelectedEndorsement] = reactExports.useState("");
  const [customEndorsement, setCustomEndorsement] = reactExports.useState("");
  ...
  const handleSubmit = async () => {
    ...
    if (useCustom) {
      if (!customEndorsement.trim()) {
        ue.error("Please enter a custom endorsement");
        return;
      }
      endorsementType = {
        __kind__: "custom",
      ...
      if (!selectedEndorsement) {
        ue.error("Please select an endorsement");
        return;
      }
    ...
    try {
      ...
      ue.success("Endorsement submitted successfully");
      onOpenChange(false);
      ...
      ue.error(error.message || "Failed to submit endorsement");
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "bg-[#1A1A1A] border-[#333333] text-[#F5F5F5] max-w-md", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogTitle, { className: "text-xl font-bold", children: [
        "Endorse ",
        playerName
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { className: "text-[#AAAAAA]", children: "Select one endorsement to verify this player's credibility. You can only endorse each player once." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 py-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { className: "text-sm font-medium text-[#F5F5F5]", children: "Predefined Endorsements" }),
        PREDEFINED_ENDORSEMENTS.map((endorsement) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            className: `w-full flex items-start gap-3 p-3 rounded-md border transition-colors cursor-pointer text-left ${selectedEndorsement === endorsement.id && !useCustom ? "border-[#2A78FF] bg-[#2A78FF]/10" : "border-[#333333] hover:border-[#666666]"}`,
            onClick: () => {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-[#F5F5F5]", children: endorsement.label }) })
            ]
          },
          endorsement.id
        ))
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 pt-2 border-t border-[#333333]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Label$1,
            {
              ...
              children: "Custom endorsement (optional)"
            }
          )
        ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          children: submitEndorsement.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
...
function ProfileView({ userId }) {
  ...
  const [endorsementDialogOpen, setEndorsementDialogOpen] = reactExports.useState(false);
  ...
  const isOwnProfile = (currentUser == null ? void 0 : currentUser.id.toString()) === userId.toString();
  const getInitials = (name) => {
    return name.split(" ").map((n) => n[0]).join("").toUpperCase().slice(0, 2);
  };
  ...
  const hasAlreadyEndorsed = endorsements == null ? void 0 : endorsements.some(
    (e) => e.endorserId.toString() === (currentUser == null ? void 0 : currentUser.id.toString())
  );
  if (profileLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container max-w-2xl mx-auto px-4 py-6 space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-6 space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
  ...
  if (!profile) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container max-w-2xl mx-auto px-4 py-16 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Profile not found" }) });
  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container max-w-2xl mx-auto px-4 py-6 space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { className: "w-20 h-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarFallback, { className: "bg-primary text-primary-foreground text-2xl font-bold", children: getInitials(profile.username) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap mb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold", children: profile.username }),
            profile.openToTeam && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Badge,
              {
                variant: "outline",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 text-sm text-muted-foreground flex-wrap", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: getGameLabel(profile.game) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "•" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: getRoleLabel(profile.role) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "•" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: getLevelLabel(profile.level) })
          ] })
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          ...
          isOwnProfile && globalReadinessScore < 70 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground pl-6 flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-green-500", children: "🟢" }),
            "Post 1 skill update today to increase this score"
          ] })
        ] }),
        hasActiveTeamRequirement ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-0.5 flex-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          isOwnProfile && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground pl-6 flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "🔧" }),
            "Improve aim & Post 2 Clips"
          ] })
        ] }) : isOwnProfile ? /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border border-dashed", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-4 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4 pt-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 rounded-md bg-card border border-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-meta mb-1", children: "Total Posts" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold", children: (timeline == null ? void 0 : timeline.length) || 0 })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 rounded-md bg-card border border-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-meta mb-1", children: "Skill Level" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold", children: getLevelLabel(profile.level) })
        ] })
      ] })
    ] }) }) }),
    endorsementSummary && /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Award, { className: "w-5 h-5 text-green-500" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold", children: "Credibility Signals" })
      ] }),
      endorsementLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: [1, 2, 3, 4].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-16 w-full" }, i)) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
          Number(endorsementSummary.scrimPartnerCount) > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 p-3 rounded-md bg-[#1A1A1A] border border-[#333333]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-4 h-4 text-green-500 flex-shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-[#AAAAAA] truncate", children: "Played scrims" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-[#666666]", children: [
                "(",
          ...
          Number(endorsementSummary.reliableCommsCount) > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 p-3 rounded-md bg-[#1A1A1A] border border-[#333333]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-4 h-4 text-green-500 flex-shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-[#AAAAAA] truncate", children: "Reliable comms" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-[#666666]", children: [
                "(",
          ...
          Number(endorsementSummary.punctualCount) > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 p-3 rounded-md bg-[#1A1A1A] border border-[#333333]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-4 h-4 text-green-500 flex-shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-[#AAAAAA] truncate", children: "Shows up on time" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-[#666666]", children: [
                "(",
          ...
          Number(endorsementSummary.consistencyCount) > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 p-3 rounded-md bg-[#1A1A1A] border border-[#333333]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-4 h-4 text-green-500 flex-shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-[#AAAAAA] truncate", children: "30-day streak" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-[#666666]", children: [
                "(",
          ...
          endorsementSummary.customEndorsements.map(
            ([nameObj, countObj]) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-4 h-4 text-green-500 flex-shrink-0" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-[#AAAAAA] truncate", children: nameObj.name }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-[#666666]", children: [
                      "(",
        ...
        Number(endorsementSummary.scrimPartnerCount) === 0 && Number(endorsementSummary.reliableCommsCount) === 0 && Number(endorsementSummary.punctualCount) === 0 && Number(endorsementSummary.consistencyCount) === 0 && endorsementSummary.customEndorsements.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Award, { className: "w-12 h-12 text-[#666666] mx-auto mb-3" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#AAAAAA] text-sm", children: isOwnProfile ? "No endorsements yet" : "Be the first to endorse this player" })
        ] })
      ] })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold px-1", children: "Skill Timeline" }),
      timelineLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: [1, 2].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4 space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      ...
      ] }) }, i)) }) : timeline && timeline.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: timeline.map((post) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        PostCard,
        {
          post,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-md bg-card border border-border flex items-center justify-center mx-auto mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "w-8 h-8 text-muted-foreground" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: isOwnProfile ? "You haven't posted any updates yet" : "No posts yet" })
      ] }) })
    ] }),
