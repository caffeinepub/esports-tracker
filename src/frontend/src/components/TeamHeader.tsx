...
import { Building2, Briefcase, Search, LogOut, Home } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export default function TeamHeader({ currentView, onViewChange }: TeamHeaderProps) {
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-56">
              <div className="px-2 py-2">
                <p className="text-sm font-medium">{teamProfile?.teamName || 'Team'}</p>
                <p className="text-xs text-muted-foreground mt-1">Team Account</p>
              </div>
              <DropdownMenuSeparator />
