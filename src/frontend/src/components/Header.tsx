...
import { TrendingUp, User, LogOut, Search } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
        ...
        <div className="flex items-center gap-1">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" size="sm" className="rounded-full p-1 h-9 w-9 ml-1">
            ...
            <DropdownMenuContent align="end" className="w-56">
              <div className="px-2 py-2">
                <p className="text-sm font-medium mb-2">{userProfile?.username}</p>
                <div className="space-y-1.5">
                  <div className="flex items-center justify-between text-xs">
                    <span className="text-muted-foreground">Global Score:</span>
                    <span className="font-semibold text-primary">{globalReadinessScore}</span>
                  </div>
                  <div className="flex items-center justify-between text-xs">
                    <span className="text-muted-foreground">Team Requirement:</span>
                    <span className="font-semibold">{readinessRequirement}</span>
                  </div>
                </div>
              </div>
              <DropdownMenuSeparator />
